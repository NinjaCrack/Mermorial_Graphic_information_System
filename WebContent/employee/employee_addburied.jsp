...
<body>
<div class="divsign">
<form action="employee_createburied.jsp" method="post" name="signup">
	...
	<tr>
	<td><input type="number" min="1500" max="2018" name="born" class="signinput"  placeholder="Year Born" required/></td>
	</tr>
	<tr>
	<td><input type="number" min="1500" max="2018" name="died" class="signinput"  placeholder="Year Died" required/></td>
	</tr>
	<tr>
