...
<header>
		<nav>	
			<ul>
			<li><a href="employee_index.jsp" title="Back to home"><img src="../image/icon/home.png" width="30px" height="30px"/> home</a></li>
			<li><a href="employee_burried.jsp" title="Burried Clients" class="active"><img src="../image/icon/list.png" width="30px" height="30px"/> list Of Buried</a></li>
			<li><a href="employee_find.jsp" title="Map of Cemetery"><img src="../image/icon/find.png" width="30px" height="30px"/> Find Grave</a></li>
			<li><a href="employee_about.jsp" title="Who are we"><img src="../image/icon/about.png" width="30px" height="30px"/> About Us</a></li>
			<li style="float:right">
						<div class="dropdown-header">
							...
							<a href="employee_edit_profile.jsp">
	...
	<%@ page import="com.Memorialsystem.Dao.buriedDao,com.Memorialsystem.tables.buried,java.util.*"%>
		...
		<h2>LIST OF BURIED</h2>
				...
				<a href="employee_addburied.jsp" style="padding:5px; color:#303233; text-decoration:none; font-size:16px;"><button class="search-btn"><b>CREATE</b></button></a>
					<br/><br/><br/>
					...
					<c:forEach items="${list}" var="u">
						<tr>
							...
							<td>${u.getdied()}</td>
							<td>${u.getlocation()}</td>
							<td><a href="employee_edit_buried.jsp?id=${u.getId()}"><img src="../image/icon/edit.png" height="30" width="30"></a></td>
						</tr>
						</c:forEach>
					</table>
	</div>
