...
<body>
<div class="divsign">
<form  action="buried_edit.jsp?id=<%=id %>" method="post" name="signup">
	...
	<tr>
	<td><input type="date" name="born" class="signinput" placeholder="Year Born" required value="<%=u.getborn() %>"/></td>
	</tr>
	<tr>
	<td><input type="date" name="died" class="signinput"  placeholder="Year Died" required value="<%=u.getdied() %>"/></td>
	</tr>
	<tr>
	<td><input type="number" min="1" max="315" name="location" class="signinput"  placeholder="Location" required value="<%=u.getlocation() %>"/></td>
	</tr>
	<tr>
		<td><a href="addImage.jsp?id=<%=id%>"><button type="button" class="signbtn">Edit image</button></a></td>
	</tr>
