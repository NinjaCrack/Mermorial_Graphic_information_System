...
<header>
		<nav>	
			...
			<li><a href="burried.jsp" title="Burried Clients" class="active"><img src="../image/icon/buried.png" width="30px" height="30px"/> Buried Client Management</a></li>
...
<a href="add_buried.jsp" style="padding:5px; color:#303233; text-decoration:none; font-size:16px; float:center;"><button class="search-btn"><b>CREATE</b></button></a>
			<br/><br/><br/>
						...
						<thead>
							...
							<tbody>
								<c:forEach items="${list}" var="u">
										<tr>
											<td><img src="../photoRetrieval.jsp?id=${u.getId() }" width="100" height="100"></td>
											<td>${u.getfirst()}</td>
											<td>${u.getmiddle()}</td>
											<td>${u.getlast()}</td>
											<td>${u.getborn()}</td>
											<td>${u.getdied()}</td>
											<td>${u.getlocation()}</td>
											<td><a href="edit_buried.jsp?id=${u.getId()}"><img src="../image/icon/edit.png" height="30" width="30"></a></td>
												<td><a href="delete_buried.jsp?id=${u.getId()}"><img src="../image/icon/delete.png" height="30" width="30"></a></td>
										</tr>
							</c:forEach>
