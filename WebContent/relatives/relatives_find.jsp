...
<header>
		<nav>	
			...
			<li><a href="relatives_find.jsp" title="Map of Cemetery" class="active"><img src="../image/icon/find.png" width="30px" height="30px"/> Find Grave</a></li>
	...
	<table cellspacing="10"  style="background-color:rgba(240,248,255,0.8);" id="result">
		...
		<%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
				...
				<td>
					<table width="100%">
						<tr>
							<td><a href="relatives_find.jsp?id=${u.getId()}"><h2 class="name"> ${u.getfirst()}  ${u.getmiddle()} ${u.getlast()}</h2></a></td>
						</tr>
						<tr>
